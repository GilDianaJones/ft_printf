...
/*   Updated: 2016/12/17 19:55:37 by gthomas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_putstrupper(char const *str);
void				ft_putnbr_oct(uintmax_t nb);
void				ft_putnbr_uns(uintmax_t n);
void				ft_putnbr_hex(uintmax_t n);
void				ft_putnbr_hexup(uintmax_t n);
void				ft_putcharupper(char c);
intmax_t			ft_intlen(intmax_t n);
uintmax_t			ft_uintlen(uintmax_t n, unsigned int base);
int					ft_iputstr(char const *str);
int					ft_iputstrupper(char const *str);
int					ft_iputwstr(int const *nbr);
